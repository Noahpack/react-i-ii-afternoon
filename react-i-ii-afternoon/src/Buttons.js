...
return(
  ...
  <div className="profile">
      <EmployeeCard obj={data[currentIndex]}/>
  </div>
      <div className="navBar">
          <button className="previous" onClick={() => this.handlePrevious(this.state.currentIndex)}>Previous</button>
          <button className="next" onClick={() => this.handleNext(this.state.currentIndex)}>Next</button>
      </div>
  </div>
)
}
